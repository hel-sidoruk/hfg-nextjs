    ...
    <>
      ...
      <div className="discipline-info">
        ...
        <div className={styles.block}>
          ...
          <div>
            ...
            <Text>
              ...
              физически сильнее, координированее, быстрее учится техникам
              борьбы. Здесь дети учатся шагать навстречу своим страхам, борясь с
              сильным соперником. Тренируя технические действия они учатся
              терпению, ведь только благодаря длительной и кропотливой работе
              технический прием сработает - он должен быть доведен до
              автоматизма.
            </Text>
          </div>
        </div>
        <div className={`${styles.block} ${styles.right}`}>
          <div>
            <Text variant={'right'}>
              Бразильское джиу-джитсу развивает базовые спортивные навыки. Это
              такой вид спорта, который требует очень серьезного контроля над
              своим телом. В секции бразильского джиу-джитсу активно практикует
              элементы акробатики во время разминки. На тренировках используются
              множество элементов из гимнастики, акробатики и динамической йоги.
            </Text>
            <Text variant={'right'}>
              ...
              ребенок учится справляться с сильным сопреником, учат его не
              пасовать перед трудностями и сражаться до победы.
            </Text>
          </div>
          <ImageAnimated
        ...
        <div className={styles.block}>
          ...
          <Text>
            ...
            выполнять большинство физически трудных упражнений легко, как бы
            играя и соревнуясь. Таким образом преодолевается монотонность
            занятий, присутствие которой делает скучным и однообразным процесс
            закрепления технических действий в борьбе.
          </Text>
        </div>
        <div className={`${styles.block} ${styles.right}`}>
          <div>
            <Text>
              ...
              тренировок требует от ребенка проявления сознательности и
              дисциплины и формирует его как личность, которая учится
              ответственно решать повседневные вопросы.
            </Text>
            <Text>
              Бразильское джиу-джитсу объединяет и развивает прочность
              товарищества. Дети поддерживают своих одноклубников в учебных
              схватках, переживают за них и поддерживают. Дружба зародившееся в
              спортивном зале- это дружба на всю жизнь.
            </Text>
          </div>
          <ImageAnimated
